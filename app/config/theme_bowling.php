...
return [
    ...
    'views' => [
        ...
        ['region' => 'footer', 'template' => 'bowl/footer', 'data' => [], 'sort' => -1],
    ...
    'data' => [
        ...
        'title_append' => ' | BOWL - Frågor och svar om bowling',

        // Stylesheets
        'stylesheets' => ['css/style.php', 'http://fonts.googleapis.com/css?family=Fjalla+One'],
